...
export const ASSESSMENT_CONTENT: AssessmentContent = {
  levels: [
    { id: 1, name: "Exploring", icon: "🌱", description: "Just starting" },
    { id: 2, name: "Developing", icon: "📈", description: "Building skills" },
    { id: 3, name: "Applying", icon: "⚡", description: "Using regularly" },
    { id: 4, name: "Leading", icon: "🌟", description: "Can teach others" },
  ],
  ...
  categories: [
    {
      ...
      description:
        "How comfortable are you using platforms like Google Classroom, Canvas, Schoology, or Moodle to organize courses, share materials, and track student progress?",
      skills: [
        {
          id: "lms-organize",
      ...
      recommendations: {
        1: {
          ...
          description:
            "Start with your school's official LMS tutorials. Focus on uploading one resource and creating one assignment this week.",
          tag: "Quick Win",
          tryIt: {
        ...
        2: {
          ...
          description:
            "Explore the announcement and calendar features. Try scheduling content to release automatically.",
        ...
        3: {
          ...
          description:
            "Use your LMS analytics to identify students who might need support. Set up a weekly check-in routine.",
          tag: "Data-Informed",
          tryIt: {
            title: "Student Progress Check",
            description:
              "Review completion rates for your last unit and reach out to 2 students who may need help.",
        ...
        4: {
          ...
          description:
            "Share your expertise! Consider leading a brief PD session or creating a tip sheet for colleagues.",
          tag: "Leadership",
          tryIt: {
    ...
    },
    {
      ...
      description:
        "How skilled are you at creating and using video content, screencasts, and multimedia resources for teaching?",
      skills: [
        {
          id: "video-record",
      ...
      recommendations: {
        1: {
          ...
          description:
            "Install Loom or Screencastify (free versions available) and record a 2-minute welcome video for students.",
          tag: "First Steps",
          tryIt: {
            title: "60-Second Screencast",
            description:
              "Record yourself explaining one concept from your next lesson. Keep it under 60 seconds!",
            difficulty: "5 minutes",
            icon: "🎥",
          },
        },
    ...
    },
    {
      ...
      description:
        "How proficient are you with digital tools that increase student participation and make learning more interactive?",
      skills: [
        {
          id: "engage-poll",
      ...
      recommendations: {
        1: {
          ...
          description:
            "Pick ONE engagement tool (Kahoot is great for beginners) and commit to using it once this week.",
          tag: "Start Simple",
          tryIt: {
        ...
        2: {
          ...
          description:
            "Try a new engagement tool that serves a different purpose (e.g., if you use Kahoot, try Padlet for collaboration).",
          tag: "Diversify",
          tryIt: {
        ...
        3: {
          ...
          description:
            "Build engagement tools into your weekly routines—entry tickets, exit tickets, or collaborative note-taking.",
          tag: "Systematize",
          tryIt: {
            title: "Weekly Ritual",
            description:
              "Establish one recurring use of an engagement tool (e.g., 'Feedback Friday' with Mentimeter).",
        ...
        4: {
          ...
          description:
            "Model creative uses of engagement tools for peers and help them adapt activities for their contexts.",
          tag: "Inspire Others",
          tryIt: {
            title: "Demo Lesson",
    ...
    },
    {
      ...
      description:
        "How comfortable are you using digital tools to assess student learning and provide meaningful feedback?",
      skills: [
        {
          id: "assess-create",
      ...
      recommendations: {
        1: {
          ...
          description:
            "Create your first Google Form quiz with automatic grading. Start with 5-10 multiple choice questions.",
          tag: "Automate Basics",
          tryIt: {
        ...
        4: {
          ...
          description:
            "Explore alternative assessment methods: portfolios, peer assessment tools, or competency-based tracking.",
          tag: "Transform Practice",
          tryIt: {
            title: "Student Choice",
            description:
              "Offer students 2-3 different ways to demonstrate learning on your next assessment.",
            difficulty: "Planning time",
            icon: "🎯",
          },
        },
    ...
    },
    {
      ...
      description:
        "How familiar are you with making digital content accessible to all learners, including those with disabilities?",
      skills: [
        {
          id: "access-design",
      ...
      recommendations: {
        ...
        2: {
          ...
          description:
            "Focus on high-impact basics: heading structure, alt text for images, and sufficient color contrast.",
          tag: "High Impact",
          tryIt: {
            title: "Alt Text Addition",
            description:
              "Add descriptive alt text to 5 images in your most-used presentation or document.",
            difficulty: "10 minutes",
            icon: "🖼️",
          },
        },
        3: {
          ...
          description:
            "Run accessibility checkers on your materials and make accessibility part of your creation process.",
          tag: "Build Habits",
          tryIt: {
            title: "Accessibility Audit",
            description:
              "Use the built-in accessibility checker in PowerPoint or Google Docs on one presentation.",
            difficulty: "15 minutes",
            icon: "🔍",
          },
        },
        4: {
          ...
          description:
            "Help establish accessibility standards in your school and support colleagues in implementation.",
          tag: "Champion Change",
          tryIt: {
            title: "Share the Why",
            description:
              "Share one accessibility tip at your next team meeting with a real student impact story.",
            difficulty: "5 minutes",
            icon: "📢",
          },
        },
    ...
    },
    {
      ...
      description:
        "How prepared are you to understand, evaluate, and thoughtfully integrate AI and emerging technologies in education?",
      skills: [
        {
          id: "ai-literacy",
      ...
      recommendations: {
        1: {
          ...
          description:
            "Spend 30 minutes exploring what AI can and cannot do. Try asking ChatGPT to help plan a lesson.",
          tag: "Get Curious",
          tryIt: {
        ...
        2: {
          ...
          description:
            "Use AI to help with time-consuming tasks: generating quiz questions, creating rubrics, or differentiating texts.",
          tag: "Save Time",
          tryIt: {
        ...
        3: {
          ...
          description:
            "Help students understand how to use AI responsibly and think critically about AI-generated content.",
        ...
        4: {
          ...
          description:
            "Help shape responsible AI use policies and model thoughtful integration for colleagues.",
