/**
 * EdTech Skills Assessment Content
 *
 * All assessment text content is centralized in this single constant.
 * This includes: skill levels, categories, skills, and recommendations.
 */
...
const ASSESSMENT_CONTENT = {
    ...
    // Level names lookup (for quick access by id)
    levelNames: {
        1: "Exploring",
        2: "Developing",
        3: "Applying",
    ...
    // Skill categories with their skills and recommendations
    categories: [
        {
            id: "lms",
            icon: "📚",
